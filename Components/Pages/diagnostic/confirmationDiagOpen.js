...
<LinearGradient colors={['#d7dbdd', '#abebc6','#d7dbdd']} style={styles.body}>
    <ScrollView>
      ...
      <View style={tailwind(' items-center ')} >
        <Text style={tailwind('text-gray-700 font-bold py-2 text-xl')}>Confirmation diagnostique:</Text>
      

        <View style={styles.row}>
        <FormButton title="Ajouter Confirmation diagnostique" onPress={() => { props.navigation.navigate("ConfirmationDiag") }} />
          <FormButton title="Liste Confirmation diagnostique" onPress={() => props.navigation.navigate("confirmationDiagList")} />
