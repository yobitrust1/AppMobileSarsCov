...
function _resolveConfig() {
  _resolveConfig = _asyncToGenerator(function*(filePath, cwd) {
    if (filePath) {
...
function mergeConfig(defaultConfig) {
  ...
  return configs.reduce(
    (totalConfig, nextConfig) =>
      _objectSpread(
        _objectSpread(_objectSpread({}, totalConfig), nextConfig),
        {},
        {
          cacheStores:
          ...
          resolver: _objectSpread(
            _objectSpread(
              _objectSpread({}, totalConfig.resolver),
              nextConfig.resolver || {}
            ),
            {},
            {
          ...
          server: _objectSpread(
            _objectSpread({}, totalConfig.server),
            nextConfig.server || {}
          ),
          symbolicator: _objectSpread(
            _objectSpread({}, totalConfig.symbolicator),
...
function _loadMetroConfigFromDisk() {
  _loadMetroConfigFromDisk = _asyncToGenerator(function*(
    ...
    const defaults = yield getDefaultConfig(rootPath);
