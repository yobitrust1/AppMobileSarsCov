...
import { NumberOrCallback, PaddingProps, VictoryThemeDefinition } from "../victory-theme/victory-theme";
...
export declare type DomainTuple = [number, number] | [Date, Date];
export declare type DomainPropObjectType = {
    x?: DomainTuple;
    y: DomainTuple;
} | {
    x: DomainTuple;
...
export declare type DomainPropType = DomainPropObjectType | DomainTuple;
export declare type PaddingType = number | [number, number];
export declare type DomainPaddingPropType = PaddingType | {
    x?: PaddingType;
    y?: PaddingType;
};
export declare type RangeTuple = [number, number];
export declare type RangePropType = RangeTuple | {
    x?: RangeTuple;
    y?: RangeTuple;
};
/**
...
export declare type ScalePropType = "linear" | "time" | "log" | "sqrt";
...
export declare type DataGetterPropType = number | string | string[] | {
